...
void husb238_set_voltage(uint8_t voltage) {
	...
	switch (voltage) {
		case 5: regValue = HUSB238_SRC_PDO_5V; break;
		case 9: regValue = HUSB238_SRC_PDO_9V; break;
		case 12: regValue = HUSB238_SRC_PDO_12V; break;
		case 15: regValue = HUSB238_SRC_PDO_15V; break;
		case 18: regValue = HUSB238_SRC_PDO_18V; break;
		case 20: regValue = HUSB238_SRC_PDO_20V; break;
		default: regValue = HUSB238_SRC_PDO_DEFAULT; break;
	}
